...
public class CountryDao {
	...
	private static final String INSERT_USUARIO_SQL = "INSERT INTO mnjgxshj (name) VALUES (?);";
	private static final String DELETE_USUARIO_SQL = "DELETE FROM mnjgxshj WHERE id = ?;";
	private static final String UPDATE_USUARIO_SQL = "UPDATE mnjgxshj SET name = ? WHERE id = ?;";
